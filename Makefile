...
all: buildheap.exe createteams.exe createteamdata.exe createheapoperationdata.exe codetest.exe
...
codetest.exe: CodeTest.cpp $(JSON)
	$(CC) $(FLAGS) CodeTest.cpp -o codetest.exe
